defmodule Integrator.Integration do
  ...
  def init(args) do
    ...
    integrator_opts = integrator_opts |> add_data_collector(Keyword.get(integration_opts, :store_data_in_genserver?))
  ...
  defp add_data_collector(integrator_opts, false = _store_data_in_genserver?), do: integrator_opts

  defp add_data_collector(integrator_opts, true = _store_data_in_genserver?) do
