defmodule Integrator.RungeKutta.StepTest do
  ...
  describe "abs_rel_norm/6" do
    ...
    test "when norm_control: false" do
      ...
      norm = Step.abs_rel_norm(t, t_old, x, abs_tolerance, rel_tolerance, opts)
    ...
    test "when norm_control: false - :f64 - starting_stepsize for high-fidelity ballode" do
      ...
      norm = Step.abs_rel_norm(x0, x0, x_zeros, abs_tol, rel_tol, opts)
    ...
    test "when norm_control: false - :f64 - for high-fidelity Bogacki-Shampine" do
      ...
      error = Step.abs_rel_norm(x_next, x_old, x_est, abs_tol, rel_tol, norm_control: false)
    ...
    test "when norm_control: true" do
      ...
      norm = Step.abs_rel_norm(x, x_old, y, abs_tolerance, rel_tolerance, opts)
