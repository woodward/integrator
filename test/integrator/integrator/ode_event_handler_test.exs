defmodule Integrator.OdeEventHandlerTest do
  ...
  describe "fzero plus interpolate" do
    test "works" do
      _t_old = 2.155396117711071
      _t_new = 2.742956500140625
      _y_old = ~V[ 1.283429405203074e-02 -2.160506093425276e+00 ]f64
      _y_new = ~V[ -1.452959132853812 -2.187778875125423 ]f64
