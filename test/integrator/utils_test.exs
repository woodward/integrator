defmodule Integrator.UtilsTest do
  ...
  describe "hermite_cubic_interpolation" do
    setup do
      ...
      t = ~V[ 1.393975803797305   1.394019009661092 ]f64

      x = ~M[    1.155084908374247   1.155040344468921
      ...
      t_out = ~V[ 1.393986605263252   1.393997406729198   1.394008208195145   1.394019009661092 ]f64
